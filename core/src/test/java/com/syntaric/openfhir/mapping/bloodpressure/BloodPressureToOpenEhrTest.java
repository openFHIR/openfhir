...
//        Assert.assertEquals(13, flat.size());
        ...
        Assert.assertEquals("at00256",
                            flat.get("blood_pressure/blood_pressure/location_of_measurement|value").getAsString());
        ...
        Assert.assertEquals("openehr",
                            flat.get("blood_pressure/blood_pressure/a24_hour_average/position|terminology")
                                    .getAsString());
    ...
    public static Bundle testBloodPressureObservation() {
        ...
        final Observation.ObservationComponentComponent component1 = new Observation.ObservationComponentComponent();
        component1.setValue(new Quantity(123));
        resource.addComponent(component1);

        final Observation.ObservationComponentComponent component2 = new Observation.ObservationComponentComponent();
        ...
        final Observation.ObservationComponentComponent component3 = new Observation.ObservationComponentComponent();
