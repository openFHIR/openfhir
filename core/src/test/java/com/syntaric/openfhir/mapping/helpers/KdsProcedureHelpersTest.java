...
public class KdsProcedureHelpersTest extends GenericHelpersTest {

    final String MODEL_MAPPINGS = "/kds/core";
    final String CONTEXT_MAPPING = "/kds/core/projects/org.highmed/KDS/procedure/procedure.context.yaml";
    final String OPT_LOCATION = "/kds/procedure/";
    ...
    @Test
    public void assertKdsProcedureHelpers() {
        ...
        assertHelpersMatchJson(allHelpers, "KdsProcedureHelpersTest.json");
    }
}
