...
public class KdsPersonHelpersTest extends GenericHelpersTest {

    final String MODEL_MAPPINGS = "/kds/core";
    final String CONTEXT_MAPPING = "/kds/core/projects/org.highmed/KDS/person/person.context.yaml";
    ...
    @Test
    public void assertKdsPersonHelpers() {
        ...
        assertHelpersMatchJson(allHelpers, "KdsPersonHelpersTest.json");
    }
}
