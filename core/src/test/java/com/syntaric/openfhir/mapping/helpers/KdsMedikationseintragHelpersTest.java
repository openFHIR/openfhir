...
public class KdsMedikationseintragHelpersTest extends GenericHelpersTest {

    final String MODEL_MAPPINGS = "/kds/core";
    final String CONTEXT_MAPPING = "/kds/core/projects/org.highmed/KDS/medikationseintrag/KDS_medikationseintrag.context.yaml";
    final String OPT_LOCATION = "/kds/medikationseintrag/";
    ...
    @Test
    public void assertKdsMedikationseintragHelpers() {
        ...
        assertHelpersMatchJson(allHelpers, "KdsMedikationseintragHelpersTest.json");
    }
}
