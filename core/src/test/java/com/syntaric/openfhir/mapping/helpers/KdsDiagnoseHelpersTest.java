...
public class KdsDiagnoseHelpersTest extends GenericHelpersTest {
    ...
    final String OPT_LOCATION = "/kds/diagnose/";
    ...
    @Test
    public void assertKdsDiagnoseHelpersInline() {
        ...
        assertHelpersMatchJson(allHelpers, "KdsDiagnoseHelpersTest.json");
    }
}
