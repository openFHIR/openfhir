...
public class KdsLaborauftragHelpersTest extends GenericHelpersTest {
    ...
    final String OPT_LOCATION = "/kds/laborauftrag/";
    ...
    @Test
    public void assertKdsLaborauftragHelpers() {
        ...
        assertHelpersMatchJson(allHelpers, "KdsLaborauftragHelpersTest.json");
    }
}
