...
public class TestOpenFhirMappingContext extends OpenFhirMappingContext {
    ...
    @Autowired
    public TestOpenFhirMappingContext(final FhirConnectModelMerger modelMerger) {
        super(modelMerger);
    }
    ...
    private void loadCoreAndExtensionMappings(final File directory,
        ...
        for (final File file : directory.listFiles()) {
            ...
            } else if (contextMetadata.getExtensions() != null && contextMetadata.getExtensions()
                    .contains(parsedMapperMetadata.getName())) {
